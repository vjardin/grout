...
static inline struct gr_capture_iface *gr_capture_ring_ifaces(struct gr_capture_ring *r) {
...
static inline struct gr_capture_slot *gr_capture_ring_slots(struct gr_capture_ring *r) {
...
static inline size_t gr_capture_ring_memsize(uint32_t slot_count, uint16_t n_ifaces) {
...
static inline bool gr_capture_ring_dequeue(struct gr_capture_ring *r, struct gr_capture_slot *out) {
